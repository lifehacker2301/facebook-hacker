...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              lifehacker@gmail.com. ^_^")
    runntxt(WW+"   ..................  liferedtv lifehacker derdle")
    runntxt(WW+"     ....       lifehacker")
    runntxt(GL+"                  your life my hack")
    runntxt(GG+"     ..........     facebook bruteforce atack")
    runntxt(Y+"    ............       please do not use eligaly")
    ...
    print GL+"  |       liferedtv lifehacker derdle blanco    |"
    print WW+"  |        TEAM : lifehacker the future hacker  |"
    print Y+"   |             FACEBOOK: DERDLE BLANCO         |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE HACKER DEVELOPER [ L.H.D ]      |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK LHD ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         PASTE HERE THE VICTIME ACC "
